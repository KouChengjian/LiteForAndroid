...
import com.easy.db.DataBase;
import com.easy.db.EasyOrm;
import com.liteutil.example.orm.Address;
import com.liteutil.example.orm.Boss;
import com.liteutil.example.orm.Company;
import com.liteutil.example.orm.Man;
import com.liteutil.example.orm.Wife;
import com.liteutil.orm.LiteOrm;
import com.liteutil.orm.db.assit.QueryBuilder;
import com.liteutil.orm.db.assit.WhereBuilder;
import com.liteutil.orm.db.model.ColumnsValue;
import com.liteutil.orm.db.model.ConflictAlgorithm;
...
public class EasyOrmActivity extends Activity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = this;
		db = EasyOrm.newSingleInstance(this, "liteorm.db");
		initData();
	}
