...
import com.kcj.peninkframe.ui.SampleDialogActivity;
        ...
        dialog.setOnOperItemClickL(new OnOperItemClickL() {
            ...
            public void onOperItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    ((SampleDialogActivity) context).setBasIn((BaseAnimatorSet) cs[position].newInstance());
                    Toastor.ShowToast(animType + "设置成功");
                    dialog.dismiss();
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public static void dissmissAnim(final Context context) {
        ...
        dialog.setOnOperItemClickL(new OnOperItemClickL() {
            ...
            public void onOperItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    String animType = contents[position];
                    ((SampleDialogActivity) context).setBasOut((BaseAnimatorSet) cs[position].newInstance());
                    Toastor.ShowToast(animType + "设置成功");
                    dialog.dismiss();
                } catch (Exception e) {
                    e.printStackTrace();
