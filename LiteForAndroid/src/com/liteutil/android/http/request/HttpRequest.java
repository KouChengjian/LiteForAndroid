...
import com.liteutil.android.http.request.body.ProgressBody;
import com.liteutil.android.http.request.body.RequestBody;
import com.liteutil.android.http.request.cookie.DbCookieStore;
...
public class HttpRequest extends UriRequest {
    ...
    public void sendRequest() throws IOException {
        ...
        if (code >= 300) {
            ...
            Log.e(httpException.toString() + ", url: " + queryUrl);
            throw httpException;
        }
