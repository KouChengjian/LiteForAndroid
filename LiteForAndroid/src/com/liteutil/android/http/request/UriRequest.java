...
import com.liteutil.android.http.request.loader.Loader;
import com.liteutil.android.http.request.loader.LoaderFactory;
...
public abstract class UriRequest implements Closeable {
    ...
    protected UriRequest(RequestParams params, Type loadType) throws Throwable {
        this.params = params;
