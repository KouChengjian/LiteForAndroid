...
import com.easyutils.http.app.BodyItemWrapper;
import com.easyutils.http.app.KeyValue;
import com.easyutils.http.body.FileBody;
import com.easyutils.http.body.InputStreamBody;
import com.easyutils.http.body.MultipartBody;
import com.easyutils.http.body.RequestBody;
import com.easyutils.http.body.StringBody;
import com.easyutils.http.body.UrlEncodedParamsBody;
            ...
            if (!multipart && fileParams.size() == 1) {
                for (KeyValue kv : fileParams) {
                    ...
                    if (value instanceof File) {
                        ...
                        HttpLog.w("Some params will be ignored for: " + this.toString());
                    }
                    break;
                }
            } else {
