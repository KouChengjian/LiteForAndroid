...
import com.kcj.peninkframe.utils.io.stream.StringBuilderWriter;

/**
 * @ClassName: IOUtils
 * @Description: 通用IO流操作工具类
 * @author: KCJ
 * @date: 
 * 
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.kcj.peninkframe.utils.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
    	com.kcj.peninkframe.utils.io.stream.ByteArrayOutputStream output = new com.kcj.peninkframe.utils.io.stream.ByteArrayOutputStream();
        copy(input, output);
