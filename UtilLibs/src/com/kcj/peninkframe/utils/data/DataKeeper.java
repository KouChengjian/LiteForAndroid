package com.kcj.peninkframe.utils.data;


import com.kcj.peninkframe.utils.ByteUtil;
import com.kcj.peninkframe.utils.HexUtil;
import com.kcj.peninkframe.utils.data.chipher.Cipher;
...
/**
 * @ClassName: DataKeeper
 * @Description: 加密存储器，持久化工具，可加密，更简单、安全的存储（持久化）、获取数字、布尔值、甚至对象
 * @author:
 * @date:
 */
