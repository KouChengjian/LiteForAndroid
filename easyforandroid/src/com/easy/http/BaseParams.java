...
import com.easy.bean.BodyItemWrapper;
import com.easy.bean.KeyValue;
import com.easy.http.body.BaseRequestBody;
import com.easy.http.body.FileBody;
import com.easy.http.body.InputStreamBody;
import com.easy.http.body.MultipartBody;
import com.easy.http.body.StringBody;
import com.easy.http.body.UrlEncodedParamsBody;
...
public abstract class BaseParams {
    ...
    public void setRequestBody(BaseRequestBody requestBody) {
    ...
    public void addParameter(String name, Object value) {
        ...
        if (method == null || HttpMethod.permitsRequestBody(method)) {
            if (!TextUtils.isEmpty(name)) {
                if (value instanceof File || value instanceof InputStream || value instanceof byte[]) { // �ļ�
                    this.fileParams.add(new KeyValue(name, value));
                } else {
    ...
    public BaseRequestBody getRequestBody() throws IOException {
        checkBodyParams();
        if (this.requestBody != null) {
            return this.requestBody;
        }
        BaseRequestBody result = null;
        if (!TextUtils.isEmpty(bodyContent)) {
